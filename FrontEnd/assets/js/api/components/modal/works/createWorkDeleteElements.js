export const createWorkModalElement = (work) => {
    ...
    if (nodeParent) {
        ...
        const workImage = `<img src="${work.imageUrl}" alt="${work.title}" />
                            <svg data-work-id="${work.id}" class='deleteBtn' width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
