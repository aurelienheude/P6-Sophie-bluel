...
<div class='overlay'>
        <dialog class='modal'>
            ...
            <div class='modal__content'>
                <img class='worksEdit' src='assets/images/appartement-paris-v.png' alt='' />
                <div class='upload'>
                    ...
                    <input type='file 'accept='image/*' max='4194304'>
                ...
                <div class='form__grp'>
                    ...
                    <select class='input' id='category'>
                        ...
                        <option value='option2'>Bar & restaurant</option>
                        <option value='option3'>super hôtel</option>
                        <option value='option3'>super hôtel</option>
                    </select>
                </div>
            </div>
